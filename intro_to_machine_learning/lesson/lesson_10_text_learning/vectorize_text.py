...
import re
import os
os.chdir('C:/Vindico/Projects/Code/Python/Python/Course/Udacity/Intro to Machine Learning/ud120-projects-master/text_learning')
...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
   ...
   #     temp_counter += 1
   #     if temp_counter < 200:
            path = "C:/Vindico/Projects/Data/Course/Udacity/Intro to Machine Learning/"+path[:-1]
           # print path
            email = open(path, "r")
